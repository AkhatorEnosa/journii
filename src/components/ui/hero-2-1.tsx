  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-col items-end absolute -right-60 -top-10 blur-xl z-0 ">
        <div className="h-[10rem] rounded-full w-[60rem] z-1 bg-gradient-to-b blur-[6rem] from-purple-600/30 to-sky-600/30"></div>
        <div className="h-[10rem] rounded-full w-[90rem] z-1 bg-gradient-to-b blur-[6rem] from-pink-900/20 to-yellow-400/20"></div>
        <div className="h-[10rem] rounded-full w-[60rem] z-1 bg-gradient-to-b blur-[6rem] from-yellow-600/20 to-sky-500/20"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <nav className="container mx-auto flex items-center justify-between px-4 py-4 mt-6">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-foreground">TradrJourney</span>
          </div>
            ...
            >
              ...
              <div className="mt-8 flex flex-col space-y-6">
                ...
                <div className="pt-4">
                  <Show when="signed-out">
                    <SignUpButton mode="modal">
                      <button className="w-full justify-start text-foreground">
                        Sign Up
                      </button>
                    </SignUpButton>
                  </Show>
                ...
                <Show when="signed-in">
                  <Link href="/dashboard" className="h-12 rounded-full bg-primary px-8 text-base font-medium text-primary-foreground hover:bg-primary/90 flex items-center justify-center">
                    Go to Dashboard
                  </Link>
                </Show>
              </div>
        ...
        {/* Badge */}
        <div className="mx-auto mt-6 flex max-w-fit items-center justify-center space-x-2 rounded-full bg-primary/10 px-4 py-2 backdrop-blur-sm">
          <span className="text-sm font-medium text-foreground">
            ✨ Introducing TradrJourney v1.0
          </span>
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          ...
          <div className="relative mx-auto my-20 w-full max-w-6xl">
            <div className="absolute inset-0 rounded shadow-lg bg-primary blur-[10rem] opacity-10" />
