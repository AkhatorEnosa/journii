...
export function exportTradesToPDF(
  ...
  doc.setFontSize(20);
  doc.setTextColor(40);
  doc.text('TradrJourney - Trading Report', pageWidth / 2, 20, { align: 'center' });
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text(
      `Page ${i} of ${pageCount} - Generated by TradrJourney`,
      pageWidth / 2,
...
export function exportAnalyticsSummaryToPDF(
  ...
  doc.setFontSize(22);
  doc.setTextColor(40);
  doc.text('TradrJourney Analytics Summary', pageWidth / 2, 30, { align: 'center' });
  ...
  // Footer
  doc.text('Powered by TradrJourney - Your Trading Journal', pageWidth / 2, 150, { align: 'center' });
