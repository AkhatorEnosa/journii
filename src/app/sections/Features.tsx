...
import { Shield, Users, TrendingUp, BarChart3, Calendar, Target } from 'lucide-react';
            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        {/* Card 1: Customizable - Span full width on mobile, 2 cols on lg */}
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <p className="mt-2 text-center text-muted-foreground">
                                    Tailor every aspect to match your trading style and preferences.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Shield className="m-auto size-12 text-muted-foreground" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-foreground">Secure by default</h2>
                                    <p className="text-muted-foreground">Your trading data is safely stored with enterprise-grade encryption and authentication.</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <BarChart3 className="w-full h-24 text-muted-foreground" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-foreground">Performance Analytics</h2>
                                    <p className="text-muted-foreground">Track win rate, average PnL, and key metrics with interactive charts and insights.</p>
                                </div>
                            </CardContent>
                        </Card>

                        {/* Card 4: Trade Tracking */}
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Target className="m-auto size-5 text-foreground" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition text-foreground">Trade Tracking</h2>
                                        <p className="text-muted-foreground">Record and analyze every trade with detailed notes, tags, and custom categories.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition text-foreground">PnL Analysis</h2>
                                        <p className="text-muted-foreground">Monitor your profit and loss over time with real-time calculations and actionable insights.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm text-foreground">Likeur</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330" alt="" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d" alt="" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm text-foreground">M. Irung</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm text-foreground">B. Ng</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
